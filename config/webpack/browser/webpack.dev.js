 ...
 */
module.exports = (env) => {
  const CONFIG = Object.assign({}, DEV_OPTIONS, env);
  return webpackMerge(commonConfig(CONFIG),
    {
      ...
      plugins: [
        ...
        //   { filepath: appRoot.resolve(`dll/${DllBundlesPlugin.resolveFile('polyfills')}`) },
        //   { filepath: appRoot.resolve(`dll/${DllBundlesPlugin.resolveFile('vendor')}`) }
        // ]),
